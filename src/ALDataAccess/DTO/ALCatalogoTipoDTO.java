...
public class ALCatalogoTipoDTO {
    ...
    public ALCatalogoTipoDTO() {
    }

    public ALCatalogoTipoDTO(int idCatalogoTipo, String nombre, String estado, String fechaCrea, String fechaModifica) {
