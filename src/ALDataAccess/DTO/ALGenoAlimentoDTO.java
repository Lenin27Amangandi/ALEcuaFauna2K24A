...
public class ALGenoAlimentoDTO {
    ...
    public ALGenoAlimentoDTO() {
    }

    public ALGenoAlimentoDTO(Integer idGenoAlimento, String nombre, String estado, String fechaCrea, String fechaModifica) {
