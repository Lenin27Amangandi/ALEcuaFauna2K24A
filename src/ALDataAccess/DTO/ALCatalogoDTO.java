...
public class ALCatalogoDTO {
    ...
    public ALCatalogoDTO() {
    }

    public ALCatalogoDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String estado, String fechaCrea,
