...
public class ALTipoHormigaDTO {
    ...
    public ALTipoHormigaDTO() {
    }

    public ALTipoHormigaDTO(Integer idTipoHormiga, String nombre, String estado, String fechaCrea, String fechaModifica) {
