...
--idCatalogoTipo2 
INSERT INTO
    Catalogo (IdCatalogoTipo, Nombre)
VALUES
    (1, 'Pais'), --idCatalogo1
...
--idCatalogo6
INSERT INTO
    Localidad (IdLocaliadPadre, IdCatalogo, Nombre)
VALUES
    (NULL, 1, 'Ecuador'),
    (1, 2, 'Sierra'),
    (1, 2, 'Oriente'),
...
CREATE TABLE
    Administrador (
        ...
        Contraseña TEXT CHECK (length(contraseña) = 6) NOT NULL UNIQUE,
